-- Скрипт для исправления ошибки с таблицей advices в Supabase
...
BEGIN
    ...
    IF table_exists THEN
        ...
        IF NOT category_exists THEN
            -- Если таблица существует, но столбца category нет, добавляем его
            RAISE NOTICE 'Таблица advices существует, но столбец category отсутствует. Добавляем столбец...';
        ...
        ELSE
            RAISE NOTICE 'Таблица advices и столбец category уже существуют.';
        END IF;
    ELSE
...
-- Проверка наличия данных в таблице advices
DO $$
DECLARE
